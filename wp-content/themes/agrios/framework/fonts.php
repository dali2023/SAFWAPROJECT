...
function agrios_standard_fonts() {
	return array(
...
function agrios_google_fonts_array() {
...
function agrios_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = agrios_google_fonts_array();
	...
	// Subset
	$subset = agrios_get_mod( 'google_font_subsets', 'latin' );
	...
	// Enqueue style
	wp_enqueue_style( 'agrios-google-font-'. $handle, $url, false, false, 'all' );
}