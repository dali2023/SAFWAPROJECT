...
Please install and activate it before starting to use the theme Agricola.
...
Theme documentation is available on https://agricola.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Agricola is Fontello.
