...
if ( ! function_exists( 'agricola_storage_get' ) ) {
	/**
	 ...
	 */
	function agricola_storage_get( $var_name, $default = '' ) {
		global $AGRICOLA_STORAGE;
		return isset( $AGRICOLA_STORAGE[ $var_name ] ) ? $AGRICOLA_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'agricola_storage_set' ) ) {
	/**
	 ...
	 */
	function agricola_storage_set( $var_name, $value ) {
		global $AGRICOLA_STORAGE;
		$AGRICOLA_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'agricola_storage_empty' ) ) {
	/**
	 ...
	 */
	function agricola_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $AGRICOLA_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $AGRICOLA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $AGRICOLA_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $AGRICOLA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'agricola_storage_isset' ) ) {
	/**
	 ...
	 */
	function agricola_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $AGRICOLA_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $AGRICOLA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $AGRICOLA_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $AGRICOLA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'agricola_storage_unset' ) ) {
	/**
	 ...
	 */
	function agricola_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $AGRICOLA_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			unset( $AGRICOLA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			unset( $AGRICOLA_STORAGE[ $var_name ][ $key ] );
		} else {
			unset( $AGRICOLA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'agricola_storage_inc' ) ) {
	/**
	 ...
	 */
	function agricola_storage_inc( $var_name, $value = 1 ) {
		global $AGRICOLA_STORAGE;
		if ( empty( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = 0;
		}
		$AGRICOLA_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'agricola_storage_concat' ) ) {
	/**
	 ...
	 */
	function agricola_storage_concat( $var_name, $value ) {
		global $AGRICOLA_STORAGE;
		if ( empty( $AGRICOLA_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'agricola_storage_get_array' ) ) {
	/**
	 ...
	 */
	function agricola_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $AGRICOLA_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) ? $AGRICOLA_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $AGRICOLA_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $AGRICOLA_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'agricola_storage_set_array' ) ) {
	/**
	 ...
	 */
	function agricola_storage_set_array( $var_name, $key, $value ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$AGRICOLA_STORAGE[ $var_name ][] = $value;
		} else {
...
if ( ! function_exists( 'agricola_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function agricola_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( '' === $key2 ) {
			$AGRICOLA_STORAGE[ $var_name ][ $key ][] = $value;
		} else {
			$AGRICOLA_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
		}
	}
}

if ( ! function_exists( 'agricola_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function agricola_storage_merge_array( $var_name, $key, $value ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$AGRICOLA_STORAGE[ $var_name ] = array_merge( $AGRICOLA_STORAGE[ $var_name ], $value );
		} else {
			$AGRICOLA_STORAGE[ $var_name ][ $key ] = array_merge( $AGRICOLA_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'agricola_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function agricola_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			agricola_array_insert_after( $AGRICOLA_STORAGE[ $var_name ], $after, $key );
		} else {
			agricola_array_insert_after( $AGRICOLA_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'agricola_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function agricola_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			agricola_array_insert_before( $AGRICOLA_STORAGE[ $var_name ], $before, $key );
		} else {
			agricola_array_insert_before( $AGRICOLA_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'agricola_storage_push_array' ) ) {
	/**
	 ...
	 */
	function agricola_storage_push_array( $var_name, $key, $value ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $AGRICOLA_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) ) {
				$AGRICOLA_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $AGRICOLA_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'agricola_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function agricola_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $AGRICOLA_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $AGRICOLA_STORAGE[ $var_name ] ) && is_array( $AGRICOLA_STORAGE[ $var_name ] ) && count( $AGRICOLA_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $AGRICOLA_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) && is_array( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) && count( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $AGRICOLA_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'agricola_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function agricola_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( empty( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ][ $key ] = 0;
		}
		$AGRICOLA_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'agricola_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function agricola_storage_concat_array( $var_name, $key, $value ) {
		global $AGRICOLA_STORAGE;
		if ( ! isset( $AGRICOLA_STORAGE[ $var_name ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ] = array();
		}
		if ( empty( $AGRICOLA_STORAGE[ $var_name ][ $key ] ) ) {
			$AGRICOLA_STORAGE[ $var_name ][ $key ] = '';
		}
		$AGRICOLA_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'agricola_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function agricola_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $AGRICOLA_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $AGRICOLA_STORAGE[ $var_name ] ) ? $AGRICOLA_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $AGRICOLA_STORAGE[ $var_name ] ) ? $AGRICOLA_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'agricola_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function agricola_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $AGRICOLA_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $AGRICOLA_STORAGE[ $var_name ]->$prop ) ? $AGRICOLA_STORAGE[ $var_name ]->$prop : $default;
	}
}
