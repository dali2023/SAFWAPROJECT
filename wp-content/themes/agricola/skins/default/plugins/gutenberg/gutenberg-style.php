...
if ( ! function_exists( 'agricola_gutenberg_get_css' ) ) {
	add_filter( 'agricola_filter_get_css', 'agricola_gutenberg_get_css', 10, 2 );
	function agricola_gutenberg_get_css( $css, $args ) {
