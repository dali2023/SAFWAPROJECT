...
if ( ! function_exists( 'agricola_woocommerce_get_css' ) ) {
	add_filter( 'agricola_filter_get_css', 'agricola_woocommerce_get_css', 10, 2 );
	function agricola_woocommerce_get_css( $css, $args ) {
...
$fdir = agricola_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
